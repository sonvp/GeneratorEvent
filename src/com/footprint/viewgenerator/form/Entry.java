...
public class Entry extends JPanel {
    ...
    public Entry(EntryList parent, Element element, VGContext context) {
        ...
        //TODO SonVo
        mEvent.addChangeListener(new CheckedEventListener());
    ...
    public void setSelected(boolean selected) {
        if (!mElement.isDeclared) {
            this.mCheck.setSelected(selected);
        }
    }

    //TODO SonVo
    public class CheckedEventListener implements ChangeListener {
        @Override
        public void stateChanged(ChangeEvent event) {
            if (mEvent.isSelected() && !mCheck.isSelected()) {
