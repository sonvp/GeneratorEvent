...
public class EntryList extends JPanel {
    ...
    private JPanel injectionsPanel;
    ...
    protected void addInjections() {
        ...
        Collections.sort(mElements, (e1, e2) -> Boolean.compare(e1.isDeclared(),e2.isDeclared()));
        int cnt = 0;
        mEntries.clear();
    ...
    protected void addButtons() {
        ...
        JLabel mAllCheckLabel = new JLabel();
        mAllCheckLabel.setText("Check All Element");

        holderPanel.add(mAllCheck);
        holderPanel.add(mAllCheckLabel);
        //TODO SonVo End
    ...
    public class CheckAllListener implements ChangeListener {
        ...
        public void stateChanged(ChangeEvent event) {
            Component[] componentList = injectionsPanel.getComponents();
            for (Component component : componentList) {
                if (component instanceof Entry) {
                    Entry entry = (Entry) component;
                    entry.setSelected(mAllCheck.isSelected());
                }
            }
        }
    }
